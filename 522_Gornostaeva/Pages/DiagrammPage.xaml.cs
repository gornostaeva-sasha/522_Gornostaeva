    ...
    public partial class DiagrammPage : Page
    {
        ...
        private void excelBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < allUsers.Count; i++)
                {
                    ...
                    worksheet.Name = allUsers[i].FIO.Length > 31 ? allUsers[i].FIO.Substring(0, 31) : allUsers[i].FIO; 
        ...
        private void wordBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            for (int index = 0; index < allUsers.Count; index++)
            {
                ...
                userParagraph.set_Style(Word.WdBuiltinStyle.wdStyleHeading2);
